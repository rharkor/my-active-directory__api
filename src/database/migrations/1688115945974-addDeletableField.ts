...
export class AddDeletableField1688115945974 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "role" ADD "deletable" boolean NOT NULL DEFAULT true`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "CHK_2cb56ddf46b3903351f7685999" CHECK ("email" IS NOT NULL OR "username" IS NOT NULL)`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "CHK_2cb56ddf46b3903351f7685999"`);
